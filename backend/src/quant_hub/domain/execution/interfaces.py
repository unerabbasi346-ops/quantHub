...
class OrderRepository(ABC):
    ...
    async def list_by_strategy(self, strategy_id: UUID) -> list[RecordedOrder]:
        """All orders for `strategy_id`, oldest-first — the Execution page's
...
class ExecutionRepository(ABC):
    ...
    async def list_by_strategy(self, strategy_id: UUID) -> list[RecordedExecution]:
        """All executions whose order was generated by `strategy_id`,
        oldest-first — joins through core.orders.strategy_id since
        core.executions itself carries no strategy_id column.
        """
        ...
